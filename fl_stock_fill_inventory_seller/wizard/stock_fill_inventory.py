...
class stock_fill_inventory(osv.osv_memory):
    ...
    def fill_inventory(self, cr, uid, ids, context=None):
        ...
        for location in location_ids:
            datas = {}
            res[location] = {}
            move_domain = ['|',('location_dest_id','=',location),('location_id','=',location),('state','=','done')]
            
            if fill_inventory.seller_id:
                product_ids = product_obj.search(cr, uid, [('seller_id','=',fill_inventory.seller_id.id)])
        ...
        for stock_move in res.values():
            for stock_move_details in stock_move.values():
                ...
                if stock_move_details.get('product_qty', 0):
                    stock_move_details.update({'original_qty': stock_move_details['product_qty']})
